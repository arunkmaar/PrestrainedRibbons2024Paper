...
!----------------------------------------------------------------------
!
! Setting up bvp for one perversion solutions for the case of preferred
...
SUBROUTINE PVLS(NDIM,U,PAR)
  ...
  ! We store L2 norm of twist tau in the third parameter. This norm is shown in the bifurcation figures in section 5 of the paper.  
  PAR(3)=GETP('NRM',2,U)
END SUBROUTINE PVLS
