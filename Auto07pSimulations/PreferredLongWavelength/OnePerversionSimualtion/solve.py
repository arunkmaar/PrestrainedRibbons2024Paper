...
epsilonValues = [x * (-0.25) for x in range(150, 350)]

print("Use changeSeparation.f90 that sets mExt = 0, and increase separation to -50.11 afterwards")
...
# Define new epsilon values to print ribbon states
...
# Merge changeSeparation results
changeSeparation = merge(changeSeparation)

print("Increasing separation between ribbon ends")

# Define epsilon values for increasing separation
epsilonValues = [x * (-1.) for x in range(50, 160)]
...
epsilonValues = [(-2. * x) for x in range(1, 100)]
